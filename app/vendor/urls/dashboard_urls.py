...
from vendor.views.payment.vendor_payment_views import VendorPaymentListView
from vendor.views.wishlist.vendor_wishlist_views import VendorWishlistView
from vendor.views.cart.vendor_wishlist_views import VendorCartInfoView
