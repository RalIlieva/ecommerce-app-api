...
urlpatterns = [
    ...
    path('categories/<int:pk>/manage/', CategoryUpdateDeleteView.as_view(), name='category-manage'),

    # Tag URLs
    path('tags/', TagListView.as_view(), name='tag-list'),
    path('tags/create/', TagCreateView.as_view(), name='tag-create'),
    path('tags/<int:pk>/manage/', TagUpdateDeleteView.as_view(), name='tag-manage'),
