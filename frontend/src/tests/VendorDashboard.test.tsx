...
//
//     // heading
//     expect(await screen.findByRole('heading', { level: 2, name: /Vendor Dashboard/i }))
//       .toBeInTheDocument();
//
//     // Stats cards
...
//     expect(screen.getByRole('button', { name: /Manage Orders/i })).toBeInTheDocument();
//     expect(screen.getByRole('button', { name: /Manage Payments/i })).toBeInTheDocument();
//     expect(screen.getByRole('button', { name: /View Cart Aggregation/i })).toBeInTheDocument();
//     expect(screen.getByRole('button', { name: /View Wishlist Aggregation/i })).toBeInTheDocument();
//
//     // Top Products list
//     const topProductsCard = screen.getByText('Top Products').closest('div')!;
//     const topListItems = within(topProductsCard).getAllByRole('listitem');
//     expect(topListItems).toHaveLength(3);
//     expect(within(topProductsCard).getByText(/P1 - \$10.00/)).toBeInTheDocument();
//     expect(within(topProductsCard).getByText(/P2 - \$20.00/)).toBeInTheDocument();
//
//     // Recent Orders list
//     const recentOrdersCard = screen.getByText('Recent Orders').closest('div')!;
//     const orderItems = within(recentOrdersCard).getAllByRole('listitem');
//     expect(orderItems).toHaveLength(2);
//     expect(within(recentOrdersCard).getByText(/Order ID: 101 \| Status: New \| Created: 2025-08-01/))
//       .toBeInTheDocument();
//   });
//
