...
// const baseProfile = {
//   profile_uuid: 'p-1',
//   gender: 'o', // matches the <select> option values: m/f/o
...
//     });
//
//     // Mock PATCH success; ensure endpoint and minimal payload
//     const updatedProfile = {
//       ...profile,
//       user: { ...profile.user, name: 'Alice Cooper' },
//     };
//     mockedPatch.mockResolvedValueOnce({ data: updatedProfile });
//
//     // Submit
//     fireEvent.click(screen.getByRole('button', { name: /Save Changes/i }));
//
//     // While submitting, UI shows "Saving..." and disables the button
//     expect(
...
//         { user: { name: 'Alice Cooper' } } // only changed field
//       )
//     );
//
//     // onUpdate is called with backend response
...
//     ).toBeInTheDocument();
//
//     // Button returns to enabled "Save Changes" after completion
//     expect(
...
//       expect(mockedPatch).toHaveBeenCalledWith(
//         `/user/profile/${profile.profile_uuid}/`,
//         { phone_number: null } // only changed, sent as null
//       )
//     );
//   });
//
...
//     renderForm();
//
//     // Change a field to force payload include (so PATCH is called)
//     fireEvent.change(screen.getByLabelText(/Name/i), {
//       target: { value: 'Al' },
//     });
//
//     // Server responds with field errors object
...
//     ).toBeInTheDocument();
//
//     // Field-level messages + is-invalid classes
//     const nameInput = screen.getByLabelText(/Name/i);
//     expect(nameInput).toHaveClass('is-invalid');
//     expect(screen.getByText(/Too short/i)).toBeInTheDocument();
//
//     const phoneInput = screen.getByLabelText(/Phone Number/i);
//     // Note: phone_number wasn't changed, so it's not in payload,
//     // but component maps all server-returned fields anyway.
//     // The UI includes an invalid-feedback DIV for phone_number:
...
//
//     fireEvent.change(screen.getByLabelText(/Name/i), {
//       target: { value: '' }, // changed from "Alice" to empty to include in payload (will send null)
//     });
//
//     mockedPatch.mockRejectedValueOnce({
//       response: {
